...
config.set_main_option('sqlalchemy.url', str(construct_db_url(DATABASE)))

# add your model's MetaData object here
# for 'autogenerate' support
print('alembic sql url: %s' % config.get_main_option("sqlalchemy.url"))
import logging
logging.info('alembicc : %s' % config.get_main_option("sqlalchemy.url"))
